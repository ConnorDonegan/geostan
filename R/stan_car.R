...
#' @param prior_phi_scale Hyperprior parameters for the scale of the CAR component \code{phi}, a numeric vector of length two. \code{phi} is scaled by the parameter \code{phi_tau} which is assigned a Gamma prior distribution; defaults to \code{prior_phi_scale = c(2, 2)}.
