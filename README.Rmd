...
If you use **geostan** in your work, please cite the package itself and supporting methodology on spatial HBMs, as well as any other foundational research as indicated by the documentation for each function you use.
...
Since **geostan** is an interface to **Stan**, also be sure to cite **Stan**:
