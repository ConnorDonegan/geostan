...
The packages depends on [Rstan](https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started), **sf**, and **spdep**. The goals is to release it to CRAN later this year.
