...
package is still under development, you can find more on the package website `connordonegan.github.io/geostan` For most (non-Ubuntu) users, installing the development version from github will not result in a functioning R package.
