...
You can find some example R and Stan code for building custom spatial models [here](https://github.com/ConnorDonegan/ESF) and [here](https://github.com/ConnorDonegan/Stan-IAR).
