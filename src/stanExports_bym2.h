...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(63, 2, "restart", "model_bym2");
    ...
    reader.add_event(110, 6, "restart", "model_bym2");
    ...
    reader.add_event(148, 14, "restart", "model_bym2");
    reader.add_event(155, 21, "include", "parts/params.stan");
    reader.add_event(155, 0, "start", "parts/params.stan");
    reader.add_event(181, 26, "end", "parts/params.stan");
    reader.add_event(181, 22, "restart", "model_bym2");
    reader.add_event(186, 27, "include", "parts/trans_params_declaration.stan");
    reader.add_event(186, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(199, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(199, 28, "restart", "model_bym2");
    ...
    reader.add_event(222, 32, "restart", "model_bym2");
    reader.add_event(230, 40, "include", "parts/model.stan");
    reader.add_event(230, 0, "start", "parts/model.stan");
    reader.add_event(266, 36, "end", "parts/model.stan");
    reader.add_event(266, 41, "restart", "model_bym2");
    reader.add_event(271, 46, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(271, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(286, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(286, 47, "restart", "model_bym2");
    reader.add_event(289, 50, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(289, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(321, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(321, 51, "restart", "model_bym2");
    reader.add_event(325, 53, "end", "model_bym2");
    return reader;
}
