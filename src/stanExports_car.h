...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(128, 6, "restart", "model_car");
    reader.add_event(138, 16, "include", "parts/trans_data.stan");
    reader.add_event(138, 0, "start", "parts/trans_data.stan");
    reader.add_event(183, 45, "end", "parts/trans_data.stan");
    reader.add_event(183, 17, "restart", "model_car");
    reader.add_event(191, 25, "include", "parts/params.stan");
    reader.add_event(191, 0, "start", "parts/params.stan");
    reader.add_event(228, 37, "end", "parts/params.stan");
    reader.add_event(228, 26, "restart", "model_car");
    reader.add_event(231, 29, "include", "parts/trans_params_declaration.stan");
    reader.add_event(231, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(239, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(239, 30, "restart", "model_car");
    reader.add_event(240, 31, "include", "parts/trans_params_expression.stan");
    reader.add_event(240, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(260, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(260, 32, "restart", "model_car");
    reader.add_event(263, 35, "include", "parts/model.stan");
    reader.add_event(263, 0, "start", "parts/model.stan");
    reader.add_event(356, 93, "end", "parts/model.stan");
    reader.add_event(356, 36, "restart", "model_car");
    reader.add_event(362, 42, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(362, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(377, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(377, 43, "restart", "model_car");
    reader.add_event(378, 44, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(378, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(410, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(410, 45, "restart", "model_car");
    reader.add_event(414, 47, "end", "model_car");
    return reader;
}
