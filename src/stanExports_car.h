...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(169, 17, "restart", "model_car");
    ...
    reader.add_event(214, 26, "restart", "model_car");
    reader.add_event(217, 29, "include", "parts/trans_params_declaration.stan");
    reader.add_event(217, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(225, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(225, 30, "restart", "model_car");
    reader.add_event(226, 31, "include", "parts/trans_params_expression.stan");
    reader.add_event(226, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(246, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(246, 32, "restart", "model_car");
    reader.add_event(249, 35, "include", "parts/model.stan");
    reader.add_event(249, 0, "start", "parts/model.stan");
    reader.add_event(337, 88, "end", "parts/model.stan");
    reader.add_event(337, 36, "restart", "model_car");
    reader.add_event(343, 42, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(343, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(358, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(358, 43, "restart", "model_car");
    reader.add_event(359, 44, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(359, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(391, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(391, 45, "restart", "model_car");
    reader.add_event(395, 47, "end", "model_car");
    return reader;
}
