...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(169, 2, "restart", "model_car");
    ...
    reader.add_event(230, 6, "restart", "model_car");
    reader.add_event(242, 18, "include", "parts/trans_data.stan");
    reader.add_event(242, 0, "start", "parts/trans_data.stan");
    reader.add_event(307, 65, "end", "parts/trans_data.stan");
    reader.add_event(307, 19, "restart", "model_car");
    reader.add_event(315, 27, "include", "parts/params.stan");
    reader.add_event(315, 0, "start", "parts/params.stan");
    reader.add_event(338, 23, "end", "parts/params.stan");
    reader.add_event(338, 28, "restart", "model_car");
    reader.add_event(342, 32, "include", "parts/trans_params_declaration.stan");
    reader.add_event(342, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(350, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(350, 33, "restart", "model_car");
    reader.add_event(351, 34, "include", "parts/trans_params_expression.stan");
    reader.add_event(351, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(371, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(371, 35, "restart", "model_car");
    reader.add_event(374, 38, "include", "parts/model.stan");
    reader.add_event(374, 0, "start", "parts/model.stan");
    reader.add_event(429, 55, "end", "parts/model.stan");
    reader.add_event(429, 39, "restart", "model_car");
    reader.add_event(435, 45, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(435, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(450, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(450, 46, "restart", "model_car");
    reader.add_event(451, 47, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(451, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(483, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(483, 48, "restart", "model_car");
    reader.add_event(487, 50, "end", "model_car");
    return reader;
}
