...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(345, 10, "include", "parts/trans_data.stan");
    reader.add_event(345, 0, "start", "parts/trans_data.stan");
    reader.add_event(381, 36, "end", "parts/trans_data.stan");
    reader.add_event(381, 11, "restart", "model_car");
    reader.add_event(387, 17, "include", "parts/params.stan");
    reader.add_event(387, 0, "start", "parts/params.stan");
    reader.add_event(410, 23, "end", "parts/params.stan");
    reader.add_event(410, 18, "restart", "model_car");
    reader.add_event(447, 55, "include", "parts/model.stan");
    reader.add_event(447, 0, "start", "parts/model.stan");
    reader.add_event(534, 87, "end", "parts/model.stan");
    reader.add_event(534, 56, "restart", "model_car");
    reader.add_event(573, 95, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(573, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(579, 6, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(579, 96, "restart", "model_car");
    reader.add_event(581, 98, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(581, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(594, 13, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(594, 99, "restart", "model_car");
    reader.add_event(605, 108, "end", "model_car");
    return reader;
}
