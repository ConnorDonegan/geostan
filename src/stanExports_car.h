...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(130, 6, "restart", "model_car");
    reader.add_event(140, 16, "include", "parts/trans_data.stan");
    reader.add_event(140, 0, "start", "parts/trans_data.stan");
    reader.add_event(171, 31, "end", "parts/trans_data.stan");
    reader.add_event(171, 17, "restart", "model_car");
    reader.add_event(179, 25, "include", "parts/params.stan");
    reader.add_event(179, 0, "start", "parts/params.stan");
    reader.add_event(221, 42, "end", "parts/params.stan");
    reader.add_event(221, 26, "restart", "model_car");
    reader.add_event(224, 29, "include", "parts/trans_params_declaration.stan");
    reader.add_event(224, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(236, 12, "end", "parts/trans_params_declaration.stan");
    reader.add_event(236, 30, "restart", "model_car");
    reader.add_event(237, 31, "include", "parts/trans_params_expression.stan");
    reader.add_event(237, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(257, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(257, 32, "restart", "model_car");
    reader.add_event(260, 35, "include", "parts/model.stan");
    reader.add_event(260, 0, "start", "parts/model.stan");
    reader.add_event(353, 93, "end", "parts/model.stan");
    reader.add_event(353, 36, "restart", "model_car");
    reader.add_event(359, 42, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(359, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(374, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(374, 43, "restart", "model_car");
    reader.add_event(375, 44, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(375, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(407, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(407, 45, "restart", "model_car");
    reader.add_event(411, 47, "end", "model_car");
    return reader;
}
