...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(131, 6, "restart", "model_car");
    reader.add_event(144, 19, "include", "parts/trans_data.stan");
    reader.add_event(144, 0, "start", "parts/trans_data.stan");
    reader.add_event(189, 45, "end", "parts/trans_data.stan");
    reader.add_event(189, 20, "restart", "model_car");
    reader.add_event(198, 29, "include", "parts/params.stan");
    reader.add_event(198, 0, "start", "parts/params.stan");
    reader.add_event(235, 37, "end", "parts/params.stan");
    reader.add_event(235, 30, "restart", "model_car");
    reader.add_event(239, 34, "include", "parts/trans_params_declaration.stan");
    reader.add_event(239, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(247, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(247, 35, "restart", "model_car");
    reader.add_event(248, 36, "include", "parts/trans_params_expression.stan");
    ...
    reader.add_event(268, 37, "restart", "model_car");
    reader.add_event(271, 40, "include", "parts/model.stan");
    reader.add_event(271, 0, "start", "parts/model.stan");
    reader.add_event(364, 93, "end", "parts/model.stan");
    reader.add_event(364, 41, "restart", "model_car");
    reader.add_event(370, 47, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(370, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(385, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(385, 48, "restart", "model_car");
    reader.add_event(386, 49, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(386, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(418, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(418, 50, "restart", "model_car");
    reader.add_event(422, 52, "end", "model_car");
    return reader;
}
