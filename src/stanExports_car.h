...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(266, 2, "restart", "model_car");
    ...
    reader.add_event(335, 6, "restart", "model_car");
    reader.add_event(339, 10, "include", "parts/trans_data.stan");
    reader.add_event(339, 0, "start", "parts/trans_data.stan");
    reader.add_event(392, 53, "end", "parts/trans_data.stan");
    reader.add_event(392, 11, "restart", "model_car");
    reader.add_event(398, 17, "include", "parts/params.stan");
    reader.add_event(398, 0, "start", "parts/params.stan");
    reader.add_event(421, 23, "end", "parts/params.stan");
    reader.add_event(421, 18, "restart", "model_car");
    reader.add_event(458, 55, "include", "parts/model.stan");
    reader.add_event(458, 0, "start", "parts/model.stan");
    reader.add_event(543, 85, "end", "parts/model.stan");
    reader.add_event(543, 56, "restart", "model_car");
    reader.add_event(578, 91, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(578, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(590, 12, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(590, 92, "restart", "model_car");
    reader.add_event(592, 94, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(592, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(605, 13, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(605, 95, "restart", "model_car");
    reader.add_event(616, 104, "end", "model_car");
    return reader;
}
        ...
        try {
            ...
            if (as_bool((is_auto_gaussian * logical_negation(prior_only)))) {
                ...
                if (as_bool(WCAR)) {
                    ...
                    lp_accum__.add(wcar_normal_lpdf<propto__>(y, fitted, car_scale, car_rho, Ax_w, Ax_v, Ax_u, Delta_inv, log_det_Delta_inv, lambda, n, pstream__));
                } else {
                    current_statement_begin__ = 552;
                    lp_accum__.add(car_normal_lpdf<propto__>(y, fitted, car_scale, car_rho, Ax_w, Ax_v, Ax_u, Cidx, Delta_inv, log_det_Delta_inv, lambda, n, pstream__));
                }
            }
            ...
            if (as_bool(logical_negation(is_auto_gaussian))) {
                ...
                if (as_bool(WCAR)) {
                    ...
                    lp_accum__.add(wcar_normal_lpdf<propto__>(log_lambda, log_lambda_mu, car_scale, car_rho, Ax_w, Ax_v, Ax_u, Delta_inv, log_det_Delta_inv, lambda, n, pstream__));
                } else {
                    current_statement_begin__ = 566;
                    lp_accum__.add(car_normal_lpdf<propto__>(log_lambda, log_lambda_mu, car_scale, car_rho, Ax_w, Ax_v, Ax_u, Cidx, Delta_inv, log_det_Delta_inv, lambda, n, pstream__));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
