...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(66, 2, "restart", "model_esf");
    reader.add_event(68, 4, "include", "parts/data.stan");
    reader.add_event(68, 0, "start", "parts/data.stan");
    reader.add_event(112, 44, "end", "parts/data.stan");
    reader.add_event(112, 5, "restart", "model_esf");
    reader.add_event(121, 14, "include", "parts/trans_data.stan");
    reader.add_event(121, 0, "start", "parts/trans_data.stan");
    reader.add_event(152, 31, "end", "parts/trans_data.stan");
    reader.add_event(152, 15, "restart", "model_esf");
    ...
    reader.add_event(186, 26, "restart", "model_esf");
    reader.add_event(191, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(191, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(204, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(204, 32, "restart", "model_esf");
    reader.add_event(211, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(211, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(231, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(231, 40, "restart", "model_esf");
    reader.add_event(241, 50, "include", "parts/model.stan");
    reader.add_event(241, 0, "start", "parts/model.stan");
    reader.add_event(275, 34, "end", "parts/model.stan");
    reader.add_event(275, 51, "restart", "model_esf");
    reader.add_event(279, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(279, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(294, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(294, 56, "restart", "model_esf");
    reader.add_event(296, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(296, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(328, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(328, 59, "restart", "model_esf");
    reader.add_event(332, 61, "end", "model_esf");
    return reader;
}
