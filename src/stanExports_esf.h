...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(80, 44, "end", "parts/data.stan");
    reader.add_event(80, 5, "restart", "model_esf");
    reader.add_event(89, 14, "include", "parts/trans_data.stan");
    reader.add_event(89, 0, "start", "parts/trans_data.stan");
    reader.add_event(120, 31, "end", "parts/trans_data.stan");
    reader.add_event(120, 15, "restart", "model_esf");
    reader.add_event(130, 25, "include", "parts/params.stan");
    reader.add_event(130, 0, "start", "parts/params.stan");
    reader.add_event(154, 24, "end", "parts/params.stan");
    reader.add_event(154, 26, "restart", "model_esf");
    reader.add_event(159, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(159, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(172, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(172, 32, "restart", "model_esf");
    reader.add_event(179, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(179, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(199, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(199, 40, "restart", "model_esf");
    reader.add_event(209, 50, "include", "parts/model.stan");
    reader.add_event(209, 0, "start", "parts/model.stan");
    reader.add_event(243, 34, "end", "parts/model.stan");
    reader.add_event(243, 51, "restart", "model_esf");
    reader.add_event(247, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(247, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(262, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(262, 56, "restart", "model_esf");
    reader.add_event(264, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(264, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(296, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(296, 59, "restart", "model_esf");
    reader.add_event(300, 61, "end", "model_esf");
    return reader;
}
