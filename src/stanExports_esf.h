...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(181, 45, "end", "parts/trans_data.stan");
    reader.add_event(181, 15, "restart", "model_esf");
    ...
    reader.add_event(228, 26, "restart", "model_esf");
    reader.add_event(233, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(233, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(241, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(241, 32, "restart", "model_esf");
    reader.add_event(248, 39, "include", "parts/trans_params_expression.stan");
    ...
    reader.add_event(268, 40, "restart", "model_esf");
    reader.add_event(271, 43, "include", "parts/model.stan");
    reader.add_event(271, 0, "start", "parts/model.stan");
    reader.add_event(364, 93, "end", "parts/model.stan");
    reader.add_event(364, 44, "restart", "model_esf");
    reader.add_event(375, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(375, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(390, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(390, 56, "restart", "model_esf");
    reader.add_event(392, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(392, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(424, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(424, 59, "restart", "model_esf");
    reader.add_event(428, 61, "end", "model_esf");
    return reader;
}
