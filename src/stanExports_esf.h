...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(164, 15, "end", "parts/trans_params_declaration.stan");
    reader.add_event(164, 32, "restart", "model_esf");
    reader.add_event(171, 39, "include", "parts/trans_params_expression.stan");
    ...
    reader.add_event(191, 40, "restart", "model_esf");
    reader.add_event(201, 50, "include", "parts/model.stan");
    reader.add_event(201, 0, "start", "parts/model.stan");
    reader.add_event(224, 23, "end", "parts/model.stan");
    reader.add_event(224, 51, "restart", "model_esf");
    reader.add_event(228, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(228, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(243, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(243, 56, "restart", "model_esf");
    reader.add_event(245, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(245, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(277, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(277, 59, "restart", "model_esf");
    reader.add_event(281, 61, "end", "model_esf");
    return reader;
}
