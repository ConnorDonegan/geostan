...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(130, 62, "end", "parts/data.stan");
    reader.add_event(130, 5, "restart", "model_esf");
    reader.add_event(139, 14, "include", "parts/trans_data.stan");
    reader.add_event(139, 0, "start", "parts/trans_data.stan");
    reader.add_event(184, 45, "end", "parts/trans_data.stan");
    reader.add_event(184, 15, "restart", "model_esf");
    reader.add_event(194, 25, "include", "parts/params.stan");
    reader.add_event(194, 0, "start", "parts/params.stan");
    reader.add_event(231, 37, "end", "parts/params.stan");
    reader.add_event(231, 26, "restart", "model_esf");
    reader.add_event(236, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(236, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(244, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(244, 32, "restart", "model_esf");
    reader.add_event(251, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(251, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(271, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(271, 40, "restart", "model_esf");
    reader.add_event(274, 43, "include", "parts/model.stan");
    reader.add_event(274, 0, "start", "parts/model.stan");
    reader.add_event(367, 93, "end", "parts/model.stan");
    reader.add_event(367, 44, "restart", "model_esf");
    reader.add_event(378, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(378, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(393, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(393, 56, "restart", "model_esf");
    reader.add_event(395, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(395, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(427, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(427, 59, "restart", "model_esf");
    reader.add_event(431, 61, "end", "model_esf");
    return reader;
}
