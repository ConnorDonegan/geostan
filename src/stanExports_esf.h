...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(32, 2, "restart", "model_esf");
    reader.add_event(34, 4, "include", "parts/data.stan");
    reader.add_event(34, 0, "start", "parts/data.stan");
    reader.add_event(72, 38, "end", "parts/data.stan");
    reader.add_event(72, 5, "restart", "model_esf");
    reader.add_event(81, 14, "include", "parts/trans_data.stan");
    reader.add_event(81, 0, "start", "parts/trans_data.stan");
    reader.add_event(112, 31, "end", "parts/trans_data.stan");
    reader.add_event(112, 15, "restart", "model_esf");
    reader.add_event(122, 25, "include", "parts/params.stan");
    reader.add_event(122, 0, "start", "parts/params.stan");
    reader.add_event(135, 13, "end", "parts/params.stan");
    reader.add_event(135, 26, "restart", "model_esf");
    reader.add_event(140, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(140, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(152, 12, "end", "parts/trans_params_declaration.stan");
    reader.add_event(152, 32, "restart", "model_esf");
    reader.add_event(159, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(159, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(178, 19, "end", "parts/trans_params_expression.stan");
    reader.add_event(178, 40, "restart", "model_esf");
    reader.add_event(188, 50, "include", "parts/model.stan");
    reader.add_event(188, 0, "start", "parts/model.stan");
    reader.add_event(210, 22, "end", "parts/model.stan");
    reader.add_event(210, 51, "restart", "model_esf");
    reader.add_event(214, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(214, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(229, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(229, 56, "restart", "model_esf");
    reader.add_event(231, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(231, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(263, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(263, 59, "restart", "model_esf");
    reader.add_event(267, 61, "end", "model_esf");
    return reader;
}
