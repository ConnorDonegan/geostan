...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(265, 2, "restart", "model_esf");
    reader.add_event(267, 4, "include", "parts/data.stan");
    reader.add_event(267, 0, "start", "parts/data.stan");
    reader.add_event(340, 73, "end", "parts/data.stan");
    reader.add_event(340, 5, "restart", "model_esf");
    reader.add_event(349, 14, "include", "parts/trans_data.stan");
    reader.add_event(349, 0, "start", "parts/trans_data.stan");
    reader.add_event(377, 28, "end", "parts/trans_data.stan");
    reader.add_event(377, 15, "restart", "model_esf");
    reader.add_event(387, 25, "include", "parts/params.stan");
    reader.add_event(387, 0, "start", "parts/params.stan");
    reader.add_event(410, 23, "end", "parts/params.stan");
    reader.add_event(410, 26, "restart", "model_esf");
    reader.add_event(415, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(415, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(423, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(423, 32, "restart", "model_esf");
    reader.add_event(430, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(430, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(448, 18, "end", "parts/trans_params_expression.stan");
    reader.add_event(448, 40, "restart", "model_esf");
    reader.add_event(451, 43, "include", "parts/model.stan");
    reader.add_event(451, 0, "start", "parts/model.stan");
    reader.add_event(538, 87, "end", "parts/model.stan");
    reader.add_event(538, 44, "restart", "model_esf");
    reader.add_event(549, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(549, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(555, 6, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(555, 56, "restart", "model_esf");
    reader.add_event(557, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(557, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(570, 13, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(570, 59, "restart", "model_esf");
    reader.add_event(574, 61, "end", "model_esf");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(std_normal_log(aux1_global));
            current_statement_begin__ = 544;
            lp_accum__.add(inv_gamma_log(aux2_global, 0.5, 0.5));
