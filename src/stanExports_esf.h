...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(75, 39, "end", "parts/data.stan");
    reader.add_event(75, 5, "restart", "model_esf");
    ...
    reader.add_event(115, 15, "restart", "model_esf");
    reader.add_event(125, 25, "include", "parts/params.stan");
    reader.add_event(125, 0, "start", "parts/params.stan");
    reader.add_event(140, 15, "end", "parts/params.stan");
    reader.add_event(140, 26, "restart", "model_esf");
    reader.add_event(145, 31, "include", "parts/trans_params_declaration.stan");
    ...
    reader.add_event(160, 32, "restart", "model_esf");
    reader.add_event(167, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(167, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(187, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(187, 40, "restart", "model_esf");
    reader.add_event(197, 50, "include", "parts/model.stan");
    reader.add_event(197, 0, "start", "parts/model.stan");
    reader.add_event(220, 23, "end", "parts/model.stan");
    reader.add_event(220, 51, "restart", "model_esf");
    reader.add_event(224, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(224, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(239, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(239, 56, "restart", "model_esf");
    reader.add_event(241, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(241, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(273, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(273, 59, "restart", "model_esf");
    reader.add_event(277, 61, "end", "model_esf");
    return reader;
}
