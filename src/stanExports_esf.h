...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(201, 2, "restart", "model_esf");
    reader.add_event(203, 4, "include", "parts/data.stan");
    reader.add_event(203, 0, "start", "parts/data.stan");
    reader.add_event(261, 58, "end", "parts/data.stan");
    reader.add_event(261, 5, "restart", "model_esf");
    reader.add_event(270, 14, "include", "parts/trans_data.stan");
    reader.add_event(270, 0, "start", "parts/trans_data.stan");
    reader.add_event(337, 67, "end", "parts/trans_data.stan");
    reader.add_event(337, 15, "restart", "model_esf");
    reader.add_event(347, 25, "include", "parts/params.stan");
    reader.add_event(347, 0, "start", "parts/params.stan");
    reader.add_event(370, 23, "end", "parts/params.stan");
    reader.add_event(370, 26, "restart", "model_esf");
    reader.add_event(375, 31, "include", "parts/trans_params_declaration.stan");
    reader.add_event(375, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(383, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(383, 32, "restart", "model_esf");
    reader.add_event(390, 39, "include", "parts/trans_params_expression.stan");
    reader.add_event(390, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(410, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(410, 40, "restart", "model_esf");
    reader.add_event(413, 43, "include", "parts/model.stan");
    reader.add_event(413, 0, "start", "parts/model.stan");
    reader.add_event(468, 55, "end", "parts/model.stan");
    reader.add_event(468, 44, "restart", "model_esf");
    reader.add_event(479, 55, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(479, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(494, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(494, 56, "restart", "model_esf");
    reader.add_event(496, 58, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(496, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(528, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(528, 59, "restart", "model_esf");
    reader.add_event(532, 61, "end", "model_esf");
    return reader;
}
