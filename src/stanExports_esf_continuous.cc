...
#include "stanExports_esf_continuous.h"

RCPP_MODULE(stan_fit4esf_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_esf_continuous")
