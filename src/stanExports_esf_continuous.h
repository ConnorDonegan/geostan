...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(32, 2, "restart", "model_esf_continuous");
    ...
    reader.add_event(51, 6, "restart", "model_esf_continuous");
    ...
    reader.add_event(57, 7, "restart", "model_esf_continuous");
    ...
    reader.add_event(70, 12, "restart", "model_esf_continuous");
    ...
    reader.add_event(79, 16, "restart", "model_esf_continuous");
    ...
    reader.add_event(86, 17, "restart", "model_esf_continuous");
    ...
    reader.add_event(111, 21, "restart", "model_esf_continuous");
    ...
    reader.add_event(123, 25, "restart", "model_esf_continuous");
    ...
    reader.add_event(130, 26, "restart", "model_esf_continuous");
    reader.add_event(130, 26, "include", "parts/y_continuous_model.stan");
    reader.add_event(130, 0, "start", "parts/y_continuous_model.stan");
    reader.add_event(137, 7, "end", "parts/y_continuous_model.stan");
    reader.add_event(137, 27, "restart", "model_esf_continuous");
    reader.add_event(166, 54, "end", "model_esf_continuous");
    return reader;
}
...
class model_esf_continuous
  : public stan::model::model_base_crtp<model_esf_continuous> {
private:
        int is_student;
        int has_sigma;
        int n;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(is_student)) {
                ...
                lp_accum__.add(student_t_log<propto__>(y, get_base1(nu, 1, "nu", 1), f, get_base1(sigma, 1, "sigma", 1)));
            } else {
                current_statement_begin__ = 135;
                lp_accum__.add(normal_log<propto__>(y, f, get_base1(sigma, 1, "sigma", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                if (as_bool(is_student)) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                student_t_log(get_base1(y, i, "y", 1), get_base1(nu, 1, "nu", 1), get_base1(fitted, i, "fitted", 1), get_base1(sigma, 1, "sigma", 1)), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 158;
                    stan::model::assign(yrep, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                student_t_rng(get_base1(nu, 1, "nu", 1), get_base1(fitted, i, "fitted", 1), get_base1(sigma, 1, "sigma", 1), base_rng__), 
                                "assigning variable yrep");
                } else {
                    current_statement_begin__ = 160;
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                normal_log(get_base1(y, i, "y", 1), get_base1(fitted, i, "fitted", 1), get_base1(sigma, 1, "sigma", 1)), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 161;
                    stan::model::assign(yrep, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                normal_rng(get_base1(fitted, i, "fitted", 1), get_base1(sigma, 1, "sigma", 1), base_rng__), 
                                "assigning variable yrep");
                }
            }
