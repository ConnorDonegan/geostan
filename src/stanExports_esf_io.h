...
namespace model_esf_io_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_esf_io");
    reader.add_event(108, 106, "end", "model_esf_io");
    return reader;
}
#include <stan_meta_header.hpp>
class model_esf_io : public prob_grad {
private:
        int n;
        int dev;
        vector_d y;
        ...
        double nu_local;
public:
    model_esf_io(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_esf_io_namespace::model_esf_io";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(f, add(intercept, multiply(EV, beta_ev)));
            ...
            if (as_bool(is_student)) {
                ...
                lp_accum__.add(student_t_log<propto__>(y, get_base1(nu, 1, "nu", 1), f, sigma));
            } else {
                current_statement_begin__ = 78;
                lp_accum__.add(normal_log<propto__>(y, f, sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_esf_io_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_esf_io_namespace::model_esf_io stan_model;
#endif
