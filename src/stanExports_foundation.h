...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(338, 71, "end", "parts/data.stan");
    reader.add_event(338, 7, "restart", "model_foundation");
    reader.add_event(361, 30, "include", "parts/trans_data.stan");
    reader.add_event(361, 0, "start", "parts/trans_data.stan");
    reader.add_event(389, 28, "end", "parts/trans_data.stan");
    reader.add_event(389, 31, "restart", "model_foundation");
    reader.add_event(407, 49, "include", "parts/params.stan");
    reader.add_event(407, 0, "start", "parts/params.stan");
    reader.add_event(423, 16, "end", "parts/params.stan");
    reader.add_event(423, 50, "restart", "model_foundation");
    reader.add_event(434, 61, "include", "parts/trans_params_declaration.stan");
    reader.add_event(434, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(441, 7, "end", "parts/trans_params_declaration.stan");
    reader.add_event(441, 62, "restart", "model_foundation");
    reader.add_event(470, 91, "include", "parts/trans_params_expression.stan");
    reader.add_event(470, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(488, 18, "end", "parts/trans_params_expression.stan");
    reader.add_event(488, 92, "restart", "model_foundation");
    reader.add_event(492, 96, "include", "parts/model.stan");
    reader.add_event(492, 0, "start", "parts/model.stan");
    reader.add_event(534, 42, "end", "parts/model.stan");
    reader.add_event(534, 97, "restart", "model_foundation");
    reader.add_event(557, 120, "include", "parts/gen_quants_declaration.stan");
    ...
    reader.add_event(563, 121, "restart", "model_foundation");
    reader.add_event(564, 122, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(564, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(576, 12, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(576, 123, "restart", "model_foundation");
    reader.add_event(580, 125, "end", "model_foundation");
    return reader;
}
