...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(169, 2, "restart", "model_glm");
    ...
    reader.add_event(229, 5, "restart", "model_glm");
    reader.add_event(232, 8, "include", "parts/trans_data.stan");
    reader.add_event(232, 0, "start", "parts/trans_data.stan");
    reader.add_event(299, 67, "end", "parts/trans_data.stan");
    reader.add_event(299, 9, "restart", "model_glm");
    reader.add_event(302, 12, "include", "parts/params.stan");
    reader.add_event(302, 0, "start", "parts/params.stan");
    reader.add_event(325, 23, "end", "parts/params.stan");
    reader.add_event(325, 13, "restart", "model_glm");
    reader.add_event(328, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(328, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(336, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(336, 17, "restart", "model_glm");
    reader.add_event(336, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(336, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(356, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(356, 18, "restart", "model_glm");
    reader.add_event(359, 21, "include", "parts/model.stan");
    reader.add_event(359, 0, "start", "parts/model.stan");
    reader.add_event(414, 55, "end", "parts/model.stan");
    reader.add_event(414, 22, "restart", "model_glm");
    reader.add_event(417, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(417, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(432, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(432, 26, "restart", "model_glm");
    reader.add_event(433, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(433, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(465, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(465, 28, "restart", "model_glm");
    reader.add_event(469, 30, "end", "model_glm");
    return reader;
}
