...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(266, 2, "restart", "model_glm");
    ...
    reader.add_event(334, 5, "restart", "model_glm");
    reader.add_event(337, 8, "include", "parts/trans_data.stan");
    reader.add_event(337, 0, "start", "parts/trans_data.stan");
    reader.add_event(390, 53, "end", "parts/trans_data.stan");
    reader.add_event(390, 9, "restart", "model_glm");
    reader.add_event(393, 12, "include", "parts/params.stan");
    reader.add_event(393, 0, "start", "parts/params.stan");
    reader.add_event(416, 23, "end", "parts/params.stan");
    reader.add_event(416, 13, "restart", "model_glm");
    reader.add_event(419, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(419, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(427, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(427, 17, "restart", "model_glm");
    reader.add_event(427, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(427, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(445, 18, "end", "parts/trans_params_expression.stan");
    reader.add_event(445, 18, "restart", "model_glm");
    reader.add_event(448, 21, "include", "parts/model.stan");
    reader.add_event(448, 0, "start", "parts/model.stan");
    reader.add_event(533, 85, "end", "parts/model.stan");
    reader.add_event(533, 22, "restart", "model_glm");
    reader.add_event(536, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(536, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(548, 12, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(548, 26, "restart", "model_glm");
    reader.add_event(549, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(549, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(562, 13, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(562, 28, "restart", "model_glm");
    reader.add_event(566, 30, "end", "model_glm");
    return reader;
}
