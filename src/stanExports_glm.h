...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(127, 5, "restart", "model_glm");
    reader.add_event(130, 8, "include", "parts/trans_data.stan");
    reader.add_event(130, 0, "start", "parts/trans_data.stan");
    reader.add_event(175, 45, "end", "parts/trans_data.stan");
    reader.add_event(175, 9, "restart", "model_glm");
    reader.add_event(178, 12, "include", "parts/params.stan");
    reader.add_event(178, 0, "start", "parts/params.stan");
    reader.add_event(215, 37, "end", "parts/params.stan");
    reader.add_event(215, 13, "restart", "model_glm");
    reader.add_event(218, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(218, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(226, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(226, 17, "restart", "model_glm");
    reader.add_event(226, 17, "include", "parts/trans_params_expression.stan");
    ...
    reader.add_event(246, 18, "restart", "model_glm");
    reader.add_event(249, 21, "include", "parts/model.stan");
    reader.add_event(249, 0, "start", "parts/model.stan");
    reader.add_event(342, 93, "end", "parts/model.stan");
    reader.add_event(342, 22, "restart", "model_glm");
    reader.add_event(345, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(345, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(360, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(360, 26, "restart", "model_glm");
    reader.add_event(361, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(361, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(393, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(393, 28, "restart", "model_glm");
    reader.add_event(397, 30, "end", "model_glm");
    return reader;
}
