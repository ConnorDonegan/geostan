...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(136, 2, "restart", "model_glm");
    ...
    reader.add_event(200, 5, "restart", "model_glm");
    reader.add_event(203, 8, "include", "parts/trans_data.stan");
    reader.add_event(203, 0, "start", "parts/trans_data.stan");
    reader.add_event(248, 45, "end", "parts/trans_data.stan");
    reader.add_event(248, 9, "restart", "model_glm");
    reader.add_event(251, 12, "include", "parts/params.stan");
    reader.add_event(251, 0, "start", "parts/params.stan");
    reader.add_event(288, 37, "end", "parts/params.stan");
    reader.add_event(288, 13, "restart", "model_glm");
    reader.add_event(291, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(291, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(299, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(299, 17, "restart", "model_glm");
    reader.add_event(299, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(299, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(319, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(319, 18, "restart", "model_glm");
    reader.add_event(322, 21, "include", "parts/model.stan");
    reader.add_event(322, 0, "start", "parts/model.stan");
    reader.add_event(415, 93, "end", "parts/model.stan");
    reader.add_event(415, 22, "restart", "model_glm");
    reader.add_event(418, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(418, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(433, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(433, 26, "restart", "model_glm");
    reader.add_event(434, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(434, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(466, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(466, 28, "restart", "model_glm");
    reader.add_event(470, 30, "end", "model_glm");
    return reader;
}
