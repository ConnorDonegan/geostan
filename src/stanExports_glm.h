...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(66, 2, "restart", "model_glm");
    ...
    reader.add_event(130, 5, "restart", "model_glm");
    reader.add_event(133, 8, "include", "parts/trans_data.stan");
    reader.add_event(133, 0, "start", "parts/trans_data.stan");
    reader.add_event(178, 45, "end", "parts/trans_data.stan");
    reader.add_event(178, 9, "restart", "model_glm");
    reader.add_event(181, 12, "include", "parts/params.stan");
    reader.add_event(181, 0, "start", "parts/params.stan");
    reader.add_event(218, 37, "end", "parts/params.stan");
    reader.add_event(218, 13, "restart", "model_glm");
    reader.add_event(221, 16, "include", "parts/trans_params_declaration.stan");
    ...
    reader.add_event(229, 17, "restart", "model_glm");
    reader.add_event(229, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(229, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(249, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(249, 18, "restart", "model_glm");
    reader.add_event(252, 21, "include", "parts/model.stan");
    reader.add_event(252, 0, "start", "parts/model.stan");
    reader.add_event(345, 93, "end", "parts/model.stan");
    reader.add_event(345, 22, "restart", "model_glm");
    reader.add_event(348, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(348, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(363, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(363, 26, "restart", "model_glm");
    reader.add_event(364, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(364, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(396, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(396, 28, "restart", "model_glm");
    reader.add_event(400, 30, "end", "model_glm");
    return reader;
}
