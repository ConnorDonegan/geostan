...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(201, 2, "restart", "model_glm");
    ...
    reader.add_event(261, 5, "restart", "model_glm");
    reader.add_event(264, 8, "include", "parts/trans_data.stan");
    reader.add_event(264, 0, "start", "parts/trans_data.stan");
    reader.add_event(331, 67, "end", "parts/trans_data.stan");
    reader.add_event(331, 9, "restart", "model_glm");
    reader.add_event(334, 12, "include", "parts/params.stan");
    reader.add_event(334, 0, "start", "parts/params.stan");
    reader.add_event(357, 23, "end", "parts/params.stan");
    reader.add_event(357, 13, "restart", "model_glm");
    reader.add_event(360, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(360, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(368, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(368, 17, "restart", "model_glm");
    reader.add_event(368, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(368, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(388, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(388, 18, "restart", "model_glm");
    reader.add_event(391, 21, "include", "parts/model.stan");
    reader.add_event(391, 0, "start", "parts/model.stan");
    reader.add_event(446, 55, "end", "parts/model.stan");
    reader.add_event(446, 22, "restart", "model_glm");
    reader.add_event(449, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(449, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(464, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(464, 26, "restart", "model_glm");
    reader.add_event(465, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(465, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(497, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(497, 28, "restart", "model_glm");
    reader.add_event(501, 30, "end", "model_glm");
    return reader;
}
