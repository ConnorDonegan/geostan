...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(172, 2, "restart", "model_glm");
    ...
    reader.add_event(236, 5, "restart", "model_glm");
    reader.add_event(239, 8, "include", "parts/trans_data.stan");
    reader.add_event(239, 0, "start", "parts/trans_data.stan");
    reader.add_event(284, 45, "end", "parts/trans_data.stan");
    reader.add_event(284, 9, "restart", "model_glm");
    reader.add_event(287, 12, "include", "parts/params.stan");
    reader.add_event(287, 0, "start", "parts/params.stan");
    reader.add_event(324, 37, "end", "parts/params.stan");
    reader.add_event(324, 13, "restart", "model_glm");
    reader.add_event(327, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(327, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(335, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(335, 17, "restart", "model_glm");
    reader.add_event(335, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(335, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(355, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(355, 18, "restart", "model_glm");
    reader.add_event(358, 21, "include", "parts/model.stan");
    reader.add_event(358, 0, "start", "parts/model.stan");
    reader.add_event(451, 93, "end", "parts/model.stan");
    reader.add_event(451, 22, "restart", "model_glm");
    reader.add_event(454, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(454, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(469, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(469, 26, "restart", "model_glm");
    reader.add_event(470, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(470, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(502, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(502, 28, "restart", "model_glm");
    reader.add_event(506, 30, "end", "model_glm");
    return reader;
}
