...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(297, 65, "end", "parts/trans_data.stan");
    reader.add_event(297, 9, "restart", "model_glm");
    reader.add_event(300, 12, "include", "parts/params.stan");
    reader.add_event(300, 0, "start", "parts/params.stan");
    reader.add_event(323, 23, "end", "parts/params.stan");
    reader.add_event(323, 13, "restart", "model_glm");
    reader.add_event(326, 16, "include", "parts/trans_params_declaration.stan");
    reader.add_event(326, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(334, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(334, 17, "restart", "model_glm");
    reader.add_event(334, 17, "include", "parts/trans_params_expression.stan");
    reader.add_event(334, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(354, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(354, 18, "restart", "model_glm");
    reader.add_event(357, 21, "include", "parts/model.stan");
    reader.add_event(357, 0, "start", "parts/model.stan");
    reader.add_event(412, 55, "end", "parts/model.stan");
    reader.add_event(412, 22, "restart", "model_glm");
    reader.add_event(415, 25, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(415, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(430, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(430, 26, "restart", "model_glm");
    reader.add_event(431, 27, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(431, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(463, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(463, 28, "restart", "model_glm");
    reader.add_event(467, 30, "end", "model_glm");
    return reader;
}
