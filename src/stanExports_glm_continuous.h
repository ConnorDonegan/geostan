...
namespace model_glm_continuous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_glm_continuous");
    ...
    reader.add_event(17, 2, "restart", "model_glm_continuous");
    ...
    reader.add_event(30, 7, "restart", "model_glm_continuous");
    ...
    reader.add_event(40, 11, "restart", "model_glm_continuous");
    ...
    reader.add_event(58, 15, "restart", "model_glm_continuous");
    ...
    reader.add_event(70, 19, "restart", "model_glm_continuous");
    reader.add_event(70, 19, "include", "parts/y_continuous_model.stan");
    reader.add_event(70, 0, "start", "parts/y_continuous_model.stan");
    reader.add_event(77, 7, "end", "parts/y_continuous_model.stan");
    reader.add_event(77, 20, "restart", "model_glm_continuous");
    reader.add_event(104, 45, "end", "model_glm_continuous");
    return reader;
}
#include <stan_meta_header.hpp>
class model_glm_continuous
  : public stan::model::model_base_crtp<model_glm_continuous> {
private:
        int is_student;
        int has_sigma;
        int n;
        ...
        matrix_d R_inverse;
public:
    model_glm_continuous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_glm_continuous_namespace::model_glm_continuous";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_glm_continuous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_glm_continuous_namespace::model_glm_continuous stan_model;
#ifndef USING_R
