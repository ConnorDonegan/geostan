...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(66, 2, "restart", "model_icar");
    ...
    reader.add_event(113, 6, "restart", "model_icar");
    ...
    reader.add_event(151, 14, "restart", "model_icar");
    reader.add_event(156, 19, "include", "parts/params.stan");
    reader.add_event(156, 0, "start", "parts/params.stan");
    reader.add_event(180, 24, "end", "parts/params.stan");
    reader.add_event(180, 20, "restart", "model_icar");
    reader.add_event(183, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(183, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(196, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(196, 24, "restart", "model_icar");
    reader.add_event(197, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(197, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(217, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(217, 26, "restart", "model_icar");
    reader.add_event(223, 32, "include", "parts/model.stan");
    reader.add_event(223, 0, "start", "parts/model.stan");
    reader.add_event(257, 34, "end", "parts/model.stan");
    reader.add_event(257, 33, "restart", "model_icar");
    reader.add_event(261, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(261, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(276, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(276, 38, "restart", "model_icar");
    reader.add_event(278, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(278, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(310, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(310, 41, "restart", "model_icar");
    reader.add_event(314, 43, "end", "model_icar");
    return reader;
}
