...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(81, 44, "end", "parts/data.stan");
    reader.add_event(81, 6, "restart", "model_icar");
    reader.add_event(88, 13, "include", "parts/trans_data.stan");
    reader.add_event(88, 0, "start", "parts/trans_data.stan");
    reader.add_event(119, 31, "end", "parts/trans_data.stan");
    reader.add_event(119, 14, "restart", "model_icar");
    reader.add_event(124, 19, "include", "parts/params.stan");
    reader.add_event(124, 0, "start", "parts/params.stan");
    reader.add_event(148, 24, "end", "parts/params.stan");
    reader.add_event(148, 20, "restart", "model_icar");
    reader.add_event(151, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(151, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(164, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(164, 24, "restart", "model_icar");
    reader.add_event(165, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(165, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(185, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(185, 26, "restart", "model_icar");
    reader.add_event(191, 32, "include", "parts/model.stan");
    reader.add_event(191, 0, "start", "parts/model.stan");
    reader.add_event(225, 34, "end", "parts/model.stan");
    reader.add_event(225, 33, "restart", "model_icar");
    reader.add_event(229, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(229, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(244, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(244, 38, "restart", "model_icar");
    reader.add_event(246, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(246, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(278, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(278, 41, "restart", "model_icar");
    reader.add_event(282, 43, "end", "model_icar");
    return reader;
}
