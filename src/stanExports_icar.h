...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(141, 17, "include", "parts/trans_data.stan");
    reader.add_event(141, 0, "start", "parts/trans_data.stan");
    reader.add_event(172, 31, "end", "parts/trans_data.stan");
    reader.add_event(172, 18, "restart", "model_icar");
    reader.add_event(182, 28, "include", "parts/params.stan");
    reader.add_event(182, 0, "start", "parts/params.stan");
    reader.add_event(224, 42, "end", "parts/params.stan");
    reader.add_event(224, 29, "restart", "model_icar");
    reader.add_event(228, 33, "include", "parts/trans_params_declaration.stan");
    reader.add_event(228, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(240, 12, "end", "parts/trans_params_declaration.stan");
    reader.add_event(240, 34, "restart", "model_icar");
    reader.add_event(246, 40, "include", "parts/trans_params_expression.stan");
    reader.add_event(246, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(266, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(266, 41, "restart", "model_icar");
    reader.add_event(270, 45, "include", "parts/model.stan");
    reader.add_event(270, 0, "start", "parts/model.stan");
    reader.add_event(363, 93, "end", "parts/model.stan");
    reader.add_event(363, 46, "restart", "model_icar");
    reader.add_event(392, 75, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(392, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(407, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(407, 76, "restart", "model_icar");
    reader.add_event(420, 89, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(420, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(452, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(452, 90, "restart", "model_icar");
    reader.add_event(456, 92, "end", "model_icar");
    return reader;
}
