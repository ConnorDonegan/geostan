...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(131, 62, "end", "parts/data.stan");
    reader.add_event(131, 6, "restart", "model_icar");
    reader.add_event(142, 17, "include", "parts/trans_data.stan");
    reader.add_event(142, 0, "start", "parts/trans_data.stan");
    reader.add_event(187, 45, "end", "parts/trans_data.stan");
    reader.add_event(187, 18, "restart", "model_icar");
    reader.add_event(197, 28, "include", "parts/params.stan");
    reader.add_event(197, 0, "start", "parts/params.stan");
    reader.add_event(234, 37, "end", "parts/params.stan");
    reader.add_event(234, 29, "restart", "model_icar");
    reader.add_event(238, 33, "include", "parts/trans_params_declaration.stan");
    reader.add_event(238, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(246, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(246, 34, "restart", "model_icar");
    reader.add_event(252, 40, "include", "parts/trans_params_expression.stan");
    reader.add_event(252, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(272, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(272, 41, "restart", "model_icar");
    reader.add_event(276, 45, "include", "parts/model.stan");
    reader.add_event(276, 0, "start", "parts/model.stan");
    reader.add_event(369, 93, "end", "parts/model.stan");
    reader.add_event(369, 46, "restart", "model_icar");
    reader.add_event(398, 75, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(398, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(413, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(413, 76, "restart", "model_icar");
    reader.add_event(426, 89, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(426, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(458, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(458, 90, "restart", "model_icar");
    reader.add_event(462, 92, "end", "model_icar");
    return reader;
}
