...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(32, 2, "restart", "model_icar");
    reader.add_event(35, 5, "include", "parts/data.stan");
    reader.add_event(35, 0, "start", "parts/data.stan");
    reader.add_event(73, 38, "end", "parts/data.stan");
    reader.add_event(73, 6, "restart", "model_icar");
    reader.add_event(80, 13, "include", "parts/trans_data.stan");
    reader.add_event(80, 0, "start", "parts/trans_data.stan");
    reader.add_event(111, 31, "end", "parts/trans_data.stan");
    reader.add_event(111, 14, "restart", "model_icar");
    reader.add_event(116, 19, "include", "parts/params.stan");
    reader.add_event(116, 0, "start", "parts/params.stan");
    reader.add_event(129, 13, "end", "parts/params.stan");
    reader.add_event(129, 20, "restart", "model_icar");
    reader.add_event(132, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(132, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(144, 12, "end", "parts/trans_params_declaration.stan");
    reader.add_event(144, 24, "restart", "model_icar");
    reader.add_event(145, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(145, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(164, 19, "end", "parts/trans_params_expression.stan");
    reader.add_event(164, 26, "restart", "model_icar");
    reader.add_event(170, 32, "include", "parts/model.stan");
    reader.add_event(170, 0, "start", "parts/model.stan");
    reader.add_event(192, 22, "end", "parts/model.stan");
    reader.add_event(192, 33, "restart", "model_icar");
    reader.add_event(196, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(196, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(211, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(211, 38, "restart", "model_icar");
    reader.add_event(213, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(213, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(245, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(245, 41, "restart", "model_icar");
    reader.add_event(249, 43, "end", "model_icar");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> offset(n);
            ...
            if (as_bool(logical_negation(model_offset))) {
                current_statement_begin__ = 139;
                stan::math::assign(offset, offset_obs);
            }
            current_statement_begin__ = 140;
            if (as_bool((primitive_value(is_poisson) && primitive_value(has_offset)))) {
                current_statement_begin__ = 140;
                stan::math::assign(offset, stan::math::log(offset));
            }
            ...
            for (size_t j_1__ = 0; j_1__ < offset_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(offset(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: offset" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable offset: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 135;
            ...
            if (as_bool(model_offset)) {
                current_statement_begin__ = 175;
                lp_accum__.add(normal_log<propto__>(offset_obs, offset, offset_me));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 134;
            validate_non_negative_index("offset", "n", n);
            Eigen::Matrix<double, Eigen::Dynamic, 1> offset(n);
            stan::math::initialize(offset, DUMMY_VAR__);
            stan::math::fill(offset, DUMMY_VAR__);
            current_statement_begin__ = 135;
            validate_non_negative_index("f", "n", n);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < offset_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "offset" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t f_j_1_max__ = n;
            for (size_t j_1__ = 0; j_1__ < f_j_1_max__; ++j_1__) {
