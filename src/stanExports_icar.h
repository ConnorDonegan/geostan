...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(34, 33, "end", "parts/priors.stan");
    reader.add_event(34, 2, "restart", "model_icar");
    reader.add_event(37, 5, "include", "parts/data.stan");
    reader.add_event(37, 0, "start", "parts/data.stan");
    reader.add_event(80, 43, "end", "parts/data.stan");
    reader.add_event(80, 6, "restart", "model_icar");
    reader.add_event(87, 13, "include", "parts/trans_data.stan");
    reader.add_event(87, 0, "start", "parts/trans_data.stan");
    reader.add_event(118, 31, "end", "parts/trans_data.stan");
    reader.add_event(118, 14, "restart", "model_icar");
    reader.add_event(123, 19, "include", "parts/params.stan");
    reader.add_event(123, 0, "start", "parts/params.stan");
    reader.add_event(147, 24, "end", "parts/params.stan");
    reader.add_event(147, 20, "restart", "model_icar");
    reader.add_event(150, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(150, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(163, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(163, 24, "restart", "model_icar");
    reader.add_event(164, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(164, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(184, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(184, 26, "restart", "model_icar");
    reader.add_event(190, 32, "include", "parts/model.stan");
    reader.add_event(190, 0, "start", "parts/model.stan");
    reader.add_event(222, 32, "end", "parts/model.stan");
    reader.add_event(222, 33, "restart", "model_icar");
    reader.add_event(226, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(226, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(241, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(241, 38, "restart", "model_icar");
    reader.add_event(243, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(243, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(275, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(275, 41, "restart", "model_icar");
    reader.add_event(279, 43, "end", "model_icar");
    return reader;
}
