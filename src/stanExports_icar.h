...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(76, 39, "end", "parts/data.stan");
    reader.add_event(76, 6, "restart", "model_icar");
    reader.add_event(83, 13, "include", "parts/trans_data.stan");
    reader.add_event(83, 0, "start", "parts/trans_data.stan");
    reader.add_event(114, 31, "end", "parts/trans_data.stan");
    reader.add_event(114, 14, "restart", "model_icar");
    reader.add_event(119, 19, "include", "parts/params.stan");
    reader.add_event(119, 0, "start", "parts/params.stan");
    reader.add_event(134, 15, "end", "parts/params.stan");
    reader.add_event(134, 20, "restart", "model_icar");
    reader.add_event(137, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(137, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(152, 15, "end", "parts/trans_params_declaration.stan");
    reader.add_event(152, 24, "restart", "model_icar");
    reader.add_event(153, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(153, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(173, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(173, 26, "restart", "model_icar");
    reader.add_event(179, 32, "include", "parts/model.stan");
    reader.add_event(179, 0, "start", "parts/model.stan");
    reader.add_event(202, 23, "end", "parts/model.stan");
    reader.add_event(202, 33, "restart", "model_icar");
    reader.add_event(206, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(206, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(221, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(221, 38, "restart", "model_icar");
    reader.add_event(223, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(223, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(255, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(255, 41, "restart", "model_icar");
    reader.add_event(259, 43, "end", "model_icar");
    return reader;
}
...
private:
        ...
        std::vector<int> x_me_prop_idx;
        std::vector<int> x_me_cont_idx;
        matrix_d x_obs;
        matrix_d x_me_prop;
        matrix_d x_me_cont;
        matrix_d sigma_me_prop;
        matrix_d sigma_me_cont;
        int has_re;
        int n_ids;
        std::vector<int> id;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "dx_me_prop", "int", context__.to_vec());
            dx_me_prop = int(0);
            vals_i__ = context__.vals_i("dx_me_prop");
            pos__ = 0;
            dx_me_prop = vals_i__[pos__++];
            check_greater_or_equal(function__, "dx_me_prop", dx_me_prop, 0);
            current_statement_begin__ = 52;
            context__.validate_dims("data initialization", "dx_me_cont", "int", context__.to_vec());
            dx_me_cont = int(0);
            vals_i__ = context__.vals_i("dx_me_cont");
            pos__ = 0;
            dx_me_cont = vals_i__[pos__++];
            check_greater_or_equal(function__, "dx_me_cont", dx_me_cont, 0);
            ...
            validate_non_negative_index("x_me_prop_idx", "(dx_me_prop ? dx_me_prop : 1 )", (dx_me_prop ? dx_me_prop : 1 ));
            context__.validate_dims("data initialization", "x_me_prop_idx", "int", context__.to_vec((dx_me_prop ? dx_me_prop : 1 )));
            x_me_prop_idx = std::vector<int>((dx_me_prop ? dx_me_prop : 1 ), int(0));
            vals_i__ = context__.vals_i("x_me_prop_idx");
            pos__ = 0;
            size_t x_me_prop_idx_k_0_max__ = (dx_me_prop ? dx_me_prop : 1 );
            for (size_t k_0__ = 0; k_0__ < x_me_prop_idx_k_0_max__; ++k_0__) {
                x_me_prop_idx[k_0__] = vals_i__[pos__++];
            }
            size_t x_me_prop_idx_i_0_max__ = (dx_me_prop ? dx_me_prop : 1 );
            for (size_t i_0__ = 0; i_0__ < x_me_prop_idx_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "x_me_prop_idx[i_0__]", x_me_prop_idx[i_0__], 0);
            }
            current_statement_begin__ = 55;
            validate_non_negative_index("x_me_cont_idx", "(dx_me_cont ? dx_me_cont : 1 )", (dx_me_cont ? dx_me_cont : 1 ));
            context__.validate_dims("data initialization", "x_me_cont_idx", "int", context__.to_vec((dx_me_cont ? dx_me_cont : 1 )));
            x_me_cont_idx = std::vector<int>((dx_me_cont ? dx_me_cont : 1 ), int(0));
            vals_i__ = context__.vals_i("x_me_cont_idx");
            pos__ = 0;
            size_t x_me_cont_idx_k_0_max__ = (dx_me_cont ? dx_me_cont : 1 );
            for (size_t k_0__ = 0; k_0__ < x_me_cont_idx_k_0_max__; ++k_0__) {
                x_me_cont_idx[k_0__] = vals_i__[pos__++];
            }
            size_t x_me_cont_idx_i_0_max__ = (dx_me_cont ? dx_me_cont : 1 );
            for (size_t i_0__ = 0; i_0__ < x_me_cont_idx_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "x_me_cont_idx[i_0__]", x_me_cont_idx[i_0__], 0);
            }
            ...
            validate_non_negative_index("x_me_prop", "n", n);
            validate_non_negative_index("x_me_prop", "(dx_me_prop ? dx_me_prop : 1 )", (dx_me_prop ? dx_me_prop : 1 ));
            context__.validate_dims("data initialization", "x_me_prop", "matrix_d", context__.to_vec(n,(dx_me_prop ? dx_me_prop : 1 )));
            x_me_prop = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, (dx_me_prop ? dx_me_prop : 1 ));
            vals_r__ = context__.vals_r("x_me_prop");
            pos__ = 0;
            size_t x_me_prop_j_2_max__ = (dx_me_prop ? dx_me_prop : 1 );
            size_t x_me_prop_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < x_me_prop_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < x_me_prop_j_1_max__; ++j_1__) {
                    x_me_prop(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            check_greater_or_equal(function__, "x_me_prop", x_me_prop, 0);
            check_less_or_equal(function__, "x_me_prop", x_me_prop, 100);
            current_statement_begin__ = 58;
            validate_non_negative_index("x_me_cont", "n", n);
            validate_non_negative_index("x_me_cont", "(dx_me_cont ? dx_me_cont : 1 )", (dx_me_cont ? dx_me_cont : 1 ));
            context__.validate_dims("data initialization", "x_me_cont", "matrix_d", context__.to_vec(n,(dx_me_cont ? dx_me_cont : 1 )));
            x_me_cont = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, (dx_me_cont ? dx_me_cont : 1 ));
            vals_r__ = context__.vals_r("x_me_cont");
            pos__ = 0;
            size_t x_me_cont_j_2_max__ = (dx_me_cont ? dx_me_cont : 1 );
            size_t x_me_cont_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < x_me_cont_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < x_me_cont_j_1_max__; ++j_1__) {
                    x_me_cont(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            current_statement_begin__ = 59;
            validate_non_negative_index("sigma_me_prop", "n", n);
            validate_non_negative_index("sigma_me_prop", "(dx_me_prop ? dx_me_prop : 1 )", (dx_me_prop ? dx_me_prop : 1 ));
            context__.validate_dims("data initialization", "sigma_me_prop", "matrix_d", context__.to_vec(n,(dx_me_prop ? dx_me_prop : 1 )));
            sigma_me_prop = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, (dx_me_prop ? dx_me_prop : 1 ));
            vals_r__ = context__.vals_r("sigma_me_prop");
            pos__ = 0;
            size_t sigma_me_prop_j_2_max__ = (dx_me_prop ? dx_me_prop : 1 );
            size_t sigma_me_prop_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < sigma_me_prop_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < sigma_me_prop_j_1_max__; ++j_1__) {
                    sigma_me_prop(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            check_greater_or_equal(function__, "sigma_me_prop", sigma_me_prop, 0);
            current_statement_begin__ = 60;
            validate_non_negative_index("sigma_me_cont", "n", n);
            validate_non_negative_index("sigma_me_cont", "(dx_me_cont ? dx_me_cont : 1 )", (dx_me_cont ? dx_me_cont : 1 ));
            context__.validate_dims("data initialization", "sigma_me_cont", "matrix_d", context__.to_vec(n,(dx_me_cont ? dx_me_cont : 1 )));
            sigma_me_cont = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n, (dx_me_cont ? dx_me_cont : 1 ));
            vals_r__ = context__.vals_r("sigma_me_cont");
            pos__ = 0;
            size_t sigma_me_cont_j_2_max__ = (dx_me_cont ? dx_me_cont : 1 );
            size_t sigma_me_cont_j_1_max__ = n;
            for (size_t j_2__ = 0; j_2__ < sigma_me_cont_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < sigma_me_cont_j_1_max__; ++j_1__) {
                    sigma_me_cont(j_1__, j_2__) = vals_r__[pos__++];
                }
            }
            check_greater_or_equal(function__, "sigma_me_cont", sigma_me_cont, 0);
            ...
            stan::math::assign(dx_all, ((dx_obs + dx_me_prop) + dx_me_cont));
            ...
            validate_non_negative_index("x_true_prop", "n", n);
            validate_non_negative_index("x_true_prop", "dx_me_prop", dx_me_prop);
            num_params_r__ += (n * dx_me_prop);
            current_statement_begin__ = 122;
            validate_non_negative_index("x_true_cont", "n", n);
            validate_non_negative_index("x_true_cont", "dx_me_cont", dx_me_cont);
            num_params_r__ += (n * dx_me_cont);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 121;
        if (!(context__.contains_r("x_true_prop")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable x_true_prop missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("x_true_prop");
        pos__ = 0U;
        validate_non_negative_index("x_true_prop", "n", n);
        validate_non_negative_index("x_true_prop", "dx_me_prop", dx_me_prop);
        context__.validate_dims("parameter initialization", "x_true_prop", "matrix_d", context__.to_vec(n,dx_me_prop));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> x_true_prop(n, dx_me_prop);
        size_t x_true_prop_j_2_max__ = dx_me_prop;
        size_t x_true_prop_j_1_max__ = n;
        for (size_t j_2__ = 0; j_2__ < x_true_prop_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_prop_j_1_max__; ++j_1__) {
                x_true_prop(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
            writer__.matrix_lub_unconstrain(0, 100, x_true_prop);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable x_true_prop: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 122;
        if (!(context__.contains_r("x_true_cont")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable x_true_cont missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("x_true_cont");
        pos__ = 0U;
        validate_non_negative_index("x_true_cont", "n", n);
        validate_non_negative_index("x_true_cont", "dx_me_cont", dx_me_cont);
        context__.validate_dims("parameter initialization", "x_true_cont", "matrix_d", context__.to_vec(n,dx_me_cont));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> x_true_cont(n, dx_me_cont);
        size_t x_true_cont_j_2_max__ = dx_me_cont;
        size_t x_true_cont_j_1_max__ = n;
        for (size_t j_2__ = 0; j_2__ < x_true_cont_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_cont_j_1_max__; ++j_1__) {
                x_true_cont(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
            writer__.matrix_unconstrain(x_true_cont);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable x_true_cont: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 123;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 121;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> x_true_prop;
            (void) x_true_prop;  // dummy to suppress unused var warning
            if (jacobian__)
                x_true_prop = in__.matrix_lub_constrain(0, 100, n, dx_me_prop, lp__);
            else
                x_true_prop = in__.matrix_lub_constrain(0, 100, n, dx_me_prop);
            current_statement_begin__ = 122;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> x_true_cont;
            (void) x_true_cont;  // dummy to suppress unused var warning
            if (jacobian__)
                x_true_cont = in__.matrix_constrain(n, dx_me_cont, lp__);
            else
                x_true_cont = in__.matrix_constrain(n, dx_me_cont);
            current_statement_begin__ = 123;
            ...
            if (as_bool(dx_me_prop)) {
                current_statement_begin__ = 142;
                stan::model::assign(x_all, 
                            stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_multi(x_me_prop_idx), stan::model::nil_index_list())), 
                            x_true_prop, 
                            "assigning variable x_all");
            }
            current_statement_begin__ = 143;
            if (as_bool(dx_me_cont)) {
                current_statement_begin__ = 143;
                stan::model::assign(x_all, 
                            stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_multi(x_me_cont_idx), stan::model::nil_index_list())), 
                            x_true_cont, 
                            "assigning variable x_all");
            }
            ...
            if (as_bool(dx_me_prop)) {
                current_statement_begin__ = 186;
                lp_accum__.add(normal_log<propto__>(to_vector(x_me_prop), to_vector(x_true_prop), to_vector(sigma_me_prop)));
            }
            current_statement_begin__ = 187;
            if (as_bool(dx_me_cont)) {
                current_statement_begin__ = 187;
                lp_accum__.add(normal_log<propto__>(to_vector(x_me_cont), to_vector(x_true_cont), to_vector(sigma_me_cont)));
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("x_true_prop");
        names__.push_back("x_true_cont");
    ...
    void get_dims(std::vector<std::vector<size_t> >& dimss__) const {
        ...
        dims__.resize(0);
        dims__.push_back(n);
        dims__.push_back(dx_me_prop);
        dimss__.push_back(dims__);
        dims__.resize(0);
        dims__.push_back(n);
        dims__.push_back(dx_me_cont);
        dimss__.push_back(dims__);
        dims__.resize(0);
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> x_true_prop = in__.matrix_lub_constrain(0, 100, n, dx_me_prop);
        size_t x_true_prop_j_2_max__ = dx_me_prop;
        size_t x_true_prop_j_1_max__ = n;
        for (size_t j_2__ = 0; j_2__ < x_true_prop_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_prop_j_1_max__; ++j_1__) {
                vars__.push_back(x_true_prop(j_1__, j_2__));
            }
        }
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> x_true_cont = in__.matrix_constrain(n, dx_me_cont);
        size_t x_true_cont_j_2_max__ = dx_me_cont;
        size_t x_true_cont_j_1_max__ = n;
        for (size_t j_2__ = 0; j_2__ < x_true_cont_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_cont_j_1_max__; ++j_1__) {
                vars__.push_back(x_true_cont(j_1__, j_2__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < x_true_prop_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_prop_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "x_true_prop" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t x_true_cont_j_2_max__ = dx_me_cont;
        ...
        for (size_t j_2__ = 0; j_2__ < x_true_cont_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < x_true_cont_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "x_true_cont" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t offset_est_j_1_max__ = (model_offset ? n : 0 );
