...
namespace model_icar_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_icar");
    ...
    reader.add_event(63, 2, "restart", "model_icar");
    ...
    reader.add_event(110, 6, "restart", "model_icar");
    reader.add_event(117, 13, "include", "parts/trans_data.stan");
    reader.add_event(117, 0, "start", "parts/trans_data.stan");
    reader.add_event(148, 31, "end", "parts/trans_data.stan");
    reader.add_event(148, 14, "restart", "model_icar");
    reader.add_event(153, 19, "include", "parts/params.stan");
    reader.add_event(153, 0, "start", "parts/params.stan");
    reader.add_event(179, 26, "end", "parts/params.stan");
    reader.add_event(179, 20, "restart", "model_icar");
    reader.add_event(182, 23, "include", "parts/trans_params_declaration.stan");
    reader.add_event(182, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(195, 13, "end", "parts/trans_params_declaration.stan");
    reader.add_event(195, 24, "restart", "model_icar");
    reader.add_event(196, 25, "include", "parts/trans_params_expression.stan");
    reader.add_event(196, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(216, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(216, 26, "restart", "model_icar");
    reader.add_event(222, 32, "include", "parts/model.stan");
    reader.add_event(222, 0, "start", "parts/model.stan");
    reader.add_event(258, 36, "end", "parts/model.stan");
    reader.add_event(258, 33, "restart", "model_icar");
    reader.add_event(262, 37, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(262, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(277, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(277, 38, "restart", "model_icar");
    reader.add_event(279, 40, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(279, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(311, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(311, 41, "restart", "model_icar");
    reader.add_event(315, 43, "end", "model_icar");
    return reader;
}
...
class model_icar
  : public stan::model::model_base_crtp<model_icar> {
private:
        int family;
        int n;
        vector_d bounds;
        ...
        matrix_d WX;
public:
    model_icar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_icar_namespace::model_icar";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "phi_scale_prior", "double", context__.to_vec());
            phi_scale_prior = double(0);
            vals_r__ = context__.vals_r("phi_scale_prior");
            pos__ = 0;
            phi_scale_prior = vals_r__[pos__++];
            check_greater_or_equal(function__, "phi_scale_prior", phi_scale_prior, 0);
            ...
            validate_non_negative_index("phi_tilde", "n", n);
            num_params_r__ += n;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("phi_tilde", "n", n);
        context__.validate_dims("parameter initialization", "phi_tilde", "vector_d", context__.to_vec(n));
        Eigen::Matrix<double, Eigen::Dynamic, 1> phi_tilde(n);
        size_t phi_tilde_j_1_max__ = n;
        ...
        current_statement_begin__ = 153;
        if (!(context__.contains_r("phi_scale")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable phi_scale missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("phi_scale");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "phi_scale", "double", context__.to_vec());
        double phi_scale(0);
        phi_scale = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, phi_scale);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable phi_scale: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 156;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                phi_tilde = in__.vector_constrain(n, lp__);
            else
                phi_tilde = in__.vector_constrain(n);
            current_statement_begin__ = 153;
            local_scalar_t__ phi_scale;
            (void) phi_scale;  // dummy to suppress unused var warning
            if (jacobian__)
                phi_scale = in__.scalar_lb_constrain(0, lp__);
            else
                phi_scale = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 156;
            ...
            stan::math::assign(f, add(f, multiply(phi_tilde, phi_scale)));
            ...
            lp_accum__.add(icar_normal_lpdf<propto__>(phi_tilde, n, node1, node2, pstream__));
            current_statement_begin__ = 222;
            lp_accum__.add(normal_log<propto__>(phi_scale, 0, phi_scale_prior));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_icar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> phi_tilde = in__.vector_constrain(n);
        size_t phi_tilde_j_1_max__ = n;
        for (size_t j_1__ = 0; j_1__ < phi_tilde_j_1_max__; ++j_1__) {
            vars__.push_back(phi_tilde(j_1__));
        }
        double phi_scale = in__.scalar_lb_constrain(0);
        vars__.push_back(phi_scale);
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(phi, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(phi_tilde, i, "phi_tilde", 1) * phi_scale), 
...
typedef model_icar_namespace::model_icar stan_model;
#ifndef USING_R
