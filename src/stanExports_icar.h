...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(201, 200, "end", "parts/priors.stan");
    reader.add_event(201, 2, "restart", "model_icar");
    reader.add_event(204, 5, "include", "parts/data.stan");
    reader.add_event(204, 0, "start", "parts/data.stan");
    reader.add_event(262, 58, "end", "parts/data.stan");
    reader.add_event(262, 6, "restart", "model_icar");
    reader.add_event(278, 22, "include", "parts/trans_data.stan");
    reader.add_event(278, 0, "start", "parts/trans_data.stan");
    reader.add_event(345, 67, "end", "parts/trans_data.stan");
    reader.add_event(345, 23, "restart", "model_icar");
    reader.add_event(354, 32, "include", "parts/params.stan");
    reader.add_event(354, 0, "start", "parts/params.stan");
    reader.add_event(377, 23, "end", "parts/params.stan");
    reader.add_event(377, 33, "restart", "model_icar");
    reader.add_event(382, 38, "include", "parts/trans_params_declaration.stan");
    reader.add_event(382, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(390, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(390, 39, "restart", "model_icar");
    reader.add_event(407, 56, "include", "parts/trans_params_expression.stan");
    reader.add_event(407, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(427, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(427, 57, "restart", "model_icar");
    reader.add_event(430, 60, "include", "parts/model.stan");
    reader.add_event(430, 0, "start", "parts/model.stan");
    reader.add_event(485, 55, "end", "parts/model.stan");
    reader.add_event(485, 61, "restart", "model_icar");
    reader.add_event(496, 72, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(496, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(511, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(511, 73, "restart", "model_icar");
    reader.add_event(512, 74, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(512, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(544, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(544, 75, "restart", "model_icar");
    reader.add_event(548, 77, "end", "model_icar");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(type, 1))) {
                ...
                stan::math::assign(phi, make_phi(phi_tilde, spatial_scale, 1, inv_sqrt_scale_factor, n, k, group_size, group_idx, pstream__));
            ...
            if (as_bool(logical_eq(type, 2))) {
                ...
                stan::math::assign(f, add(f, convolve_bym(phi, theta, n, k, group_size, group_idx, pstream__)));
            }
            current_statement_begin__ = 402;
            if (as_bool(logical_eq(type, 3))) {
                current_statement_begin__ = 403;
                stan::math::assign(theta, multiply((spatial_scale * stan::math::sqrt((1 - get_base1(rho, 1, "rho", 1)))), theta_tilde));
                current_statement_begin__ = 404;
                stan::math::assign(phi, make_phi(phi_tilde, spatial_scale, get_base1(rho, 1, "rho", 1), inv_sqrt_scale_factor, n, k, group_size, group_idx, pstream__));
                ...
                stan::math::assign(f, add(f, convolve_bym2(phi_tilde, theta_tilde, spatial_scale, n, k, group_size, group_idx, get_base1(rho, 1, "rho", 1), inv_sqrt_scale_factor, pstream__)));
            }
            ...
            lp_accum__.add(icar_normal_lpdf<propto__>(phi_tilde, spatial_scale, node1, node2, k, group_size, group_idx, has_theta, pstream__));
            current_statement_begin__ = 493;
            if (as_bool(m)) {
                current_statement_begin__ = 493;
                lp_accum__.add(normal_log<propto__>(alpha_phi, 0, get_base1(alpha_prior, 2, "alpha_prior", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
