...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(136, 135, "end", "parts/priors.stan");
    reader.add_event(136, 2, "restart", "model_icar");
    reader.add_event(139, 5, "include", "parts/data.stan");
    reader.add_event(139, 0, "start", "parts/data.stan");
    reader.add_event(201, 62, "end", "parts/data.stan");
    reader.add_event(201, 6, "restart", "model_icar");
    reader.add_event(215, 20, "include", "parts/trans_data.stan");
    reader.add_event(215, 0, "start", "parts/trans_data.stan");
    reader.add_event(260, 45, "end", "parts/trans_data.stan");
    reader.add_event(260, 21, "restart", "model_icar");
    reader.add_event(268, 29, "include", "parts/params.stan");
    reader.add_event(268, 0, "start", "parts/params.stan");
    reader.add_event(305, 37, "end", "parts/params.stan");
    reader.add_event(305, 30, "restart", "model_icar");
    reader.add_event(310, 35, "include", "parts/trans_params_declaration.stan");
    reader.add_event(310, 0, "start", "parts/trans_params_declaration.stan");
    reader.add_event(318, 8, "end", "parts/trans_params_declaration.stan");
    reader.add_event(318, 36, "restart", "model_icar");
    reader.add_event(328, 46, "include", "parts/trans_params_expression.stan");
    reader.add_event(328, 0, "start", "parts/trans_params_expression.stan");
    reader.add_event(348, 20, "end", "parts/trans_params_expression.stan");
    reader.add_event(348, 47, "restart", "model_icar");
    reader.add_event(351, 50, "include", "parts/model.stan");
    reader.add_event(351, 0, "start", "parts/model.stan");
    reader.add_event(444, 93, "end", "parts/model.stan");
    reader.add_event(444, 51, "restart", "model_icar");
    reader.add_event(456, 63, "include", "parts/gen_quants_declaration.stan");
    reader.add_event(456, 0, "start", "parts/gen_quants_declaration.stan");
    reader.add_event(471, 15, "end", "parts/gen_quants_declaration.stan");
    reader.add_event(471, 64, "restart", "model_icar");
    reader.add_event(478, 71, "include", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(478, 0, "start", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(510, 32, "end", "parts/gen_quants_expression_in_loop.stan");
    reader.add_event(510, 72, "restart", "model_icar");
    reader.add_event(514, 74, "end", "model_icar");
    return reader;
}
...
template <bool propto, typename T0__, typename T5__>
typename boost::math::tools::promote_args<T0__, T5__>::type
icar_normal_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& phi,
                     const int& n,
                     const int& n_edges,
                     const std::vector<int>& node1,
                     const std::vector<int>& node2,
                     const Eigen::Matrix<T5__, Eigen::Dynamic, 1>& weight,
                     const int& k,
    ...
    try {
        ...
        validate_non_negative_index("d", "n_edges", n_edges);
        Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> d(n_edges);
        stan::math::initialize(d, DUMMY_VAR__);
        stan::math::fill(d, DUMMY_VAR__);
        stan::math::assign(d,subtract(stan::model::rvalue(phi, stan::model::cons_list(stan::model::index_multi(node1), stan::model::nil_index_list()), "phi"), stan::model::rvalue(phi, stan::model::cons_list(stan::model::index_multi(node2), stan::model::nil_index_list()), "phi")));
        current_statement_begin__ = 83;
        stan::math::assign(lp, (-(0.5) * dot_product(weight, elt_multiply(d, d))));
...
icar_normal_lpdf(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& phi,
                     ...
                     const std::vector<int>& group_idx,
                     const int& has_theta, std::ostream* pstream__) {
    return icar_normal_lpdf<false>(phi,n,n_edges,node1,node2,weight,k,group_size,group_idx,has_theta, pstream__);
}
struct icar_normal_lpdf_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& phi,
        ...
        return icar_normal_lpdf(phi, n, n_edges, node1, node2, weight, k, group_size, group_idx, has_theta, pstream__);
    }
};
template <typename T0__, typename T1__, typename T6__, typename T7__>
Eigen::Matrix<typename boost::math::tools::promote_args<T0__, T1__, T6__, T7__>::type, Eigen::Dynamic, 1>
convolve_bym2(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& phi,
                  ...
                  const std::vector<int>& group_idx,
                  const T6__& rho,
                  const Eigen::Matrix<T7__, Eigen::Dynamic, 1>& scale_factor, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T6__, T7__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
        local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    ...
    try {
        ...
        for (int j = 1; j <= k; ++j) {
            ...
            stan::model::assign(convolution, 
                        ...
                        add(multiply(stan::math::sqrt((rho * inv(get_base1(scale_factor, j, "scale_factor", 1)))), stan::model::rvalue(phi, stan::model::cons_list(stan::model::index_multi(segment(group_idx, pos, get_base1(group_size, j, "group_size", 1))), stan::model::nil_index_list()), "phi")), multiply(stan::math::sqrt((1 - rho)), stan::model::rvalue(theta, stan::model::cons_list(stan::model::index_multi(segment(group_idx, pos, get_base1(group_size, j, "group_size", 1))), stan::model::nil_index_list()), "theta"))), 
...
struct convolve_bym2_functor__ {
    ...
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic, 1>& phi,
                  ...
                  const std::vector<int>& group_idx,
                  const T6__& rho,
                  const Eigen::Matrix<T7__, Eigen::Dynamic, 1>& scale_factor, std::ostream* pstream__) const {
        return convolve_bym2(phi, theta, n, k, group_size, group_idx, rho, scale_factor, pstream__);
    }
};
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("logit_rho", "logical_eq(type, 3)", logical_eq(type, 3));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("logit_rho", "logical_eq(type, 3)", logical_eq(type, 3));
        context__.validate_dims("parameter initialization", "logit_rho", "double", context__.to_vec(logical_eq(type, 3)));
        std::vector<double> logit_rho(logical_eq(type, 3), double(0));
        size_t logit_rho_k_0_max__ = logical_eq(type, 3);
        for (size_t k_0__ = 0; k_0__ < logit_rho_k_0_max__; ++k_0__) {
            logit_rho[k_0__] = vals_r__[pos__++];
        }
        size_t logit_rho_i_0_max__ = logical_eq(type, 3);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            size_t logit_rho_d_0_max__ = logical_eq(type, 3);
            ...
            std::vector<local_scalar_t__> rho(logical_eq(type, 3), local_scalar_t__(0));
            ...
            if (as_bool(logical_eq(type, 2))) {
                ...
                stan::math::assign(convolution, add(multiply(phi_tilde, spatial_scale), multiply(theta_tilde, get_base1(theta_scale, 1, "theta_scale", 1))));
            ...
            if (as_bool(logical_eq(type, 3))) {
                ...
                stan::math::assign(convolution, convolve_bym2(phi_tilde, theta_tilde, n, k, group_size, group_idx, get_base1(rho, 1, "rho", 1), scale_factor, pstream__));
            ...
            lp_accum__.add(icar_normal_lpdf<propto__>(phi_tilde, n, n_edges, node1, node2, weight, k, group_size, group_idx, has_theta, pstream__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
