...
#include "stanExports_icar_continuous.h"

RCPP_MODULE(stan_fit4icar_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_icar_continuous")
