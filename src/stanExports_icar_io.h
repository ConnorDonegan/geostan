...
namespace model_icar_io_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_icar_io");
    reader.add_event(81, 79, "end", "model_icar_io");
    return reader;
}
...
class model_icar_io : public prob_grad {
private:
        int n;
        int n_edges;
        vector_d y;
        ...
        std::vector<int> id;
public:
    model_icar_io(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_icar_io_namespace::model_icar_io";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(fitted, add(intercept, phi));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_icar_io_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_icar_io_namespace::model_icar_io stan_model;
#endif
