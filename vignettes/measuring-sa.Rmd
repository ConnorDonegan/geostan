...
If instead, we used the binary coding scheme for the spatial weights matrix `C` then the y-axis (`C * y.c`) would show the *sum* of spatially-lagged values and the Moran coefficient will differ from the regression line.
