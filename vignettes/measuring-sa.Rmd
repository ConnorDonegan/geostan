...
Given the purpose of ESDA, hypothesis tests are, in many cases, neither helpful nor necessary. This statement is consistent with the principles presented in Tukey's *Exploratory Data Analysis* [@tukey_1993], although it conflicts with most texts on spatial data analysis. 
...
The formula for the Moran coefficient (MC), an index of SA, is
