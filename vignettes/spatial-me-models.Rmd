...
As noted previously, **geostan** will use its default priors if none are provided.

```{r}
print(ME$prior)
```

The following code demonstrates setting custom priors for $\mu$ (location) and $\tau$ (scale) (see `?priors` for details):
