...
```{r}
georgia[c(91, 105, 90, 39, 143), c("NAME", "white", "black", "ai", "ICE", "ICE.se", "college", "college.se")]
```
...
If the `ME` list doesn't have a slot with `car_parts`, it will automatically use a non-spatial Student's t model instead of the CAR model. 
